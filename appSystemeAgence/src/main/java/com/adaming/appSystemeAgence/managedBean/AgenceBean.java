...
public class AgenceBean implements Serializable {
	...
	/**
	 * R�cup�ration de l'identifiant du client choisi dans la page etrecherche du client correspondant dans la base de donn�es.
	 */
	public void selectClient() {
		...
		System.out
				.println("===== AgenceBean.java, m�thode selectClient - Client r�cup�r� : "
						+ client + ". =====");
		setClient(client);
	}
